...
public class CommandTestUtil {
    ...
    public static final String VALID_RATING_ASSIGNED = "3";
    public static final String VALID_RATING_UNASSIGNED = "-1";
    ...
    public static final String RATING_DESC_ASSIGNED = " " + PREFIX_RATING + VALID_RATING_ASSIGNED;
    public static final String RATING_DESC_UNASSIGNED = " " + PREFIX_RATING + VALID_RATING_UNASSIGNED;

    public static final String INVALID_NAME_DESC = " " + PREFIX_NAME + "James&"; // '&' not allowed in names
    public static final String INVALID_PHONE_DESC = " " + PREFIX_PHONE + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_EMAIL + "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_JOB_POSITION_DESC = " " + PREFIX_JOB_POSITION
            + "!&&Front-end &Engineer"; // '& not allowed in Job Position
    ...
    public static final String INVALID_RATING_DESC = " " + PREFIX_RATING + "6";
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withJobPosition(VALID_JOB_POSITION_AMY)
                .withStatus(VALID_STATUS_AMY).withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND)
                .withRating(VALID_RATING_UNASSIGNED).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withJobPosition(VALID_JOB_POSITION_BOB)
                .withAddress(VALID_ADDRESS_BOB).withStatus(VALID_STATUS_BOB)
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withRating(VALID_RATING_UNASSIGNED).build();
    }
