...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_CHARACTER_FILENAME_FORMAT = "Invalid filename. Only letters, digits, '-', '_', '.', and spaces are allowed.";
    public static final String MESSAGE_INVALID_COMMAND_FORMAT = "Invalid command format! \n%1$s";
    public static final String MESSAGE_INVALID_EMPTY_FILENAME_FORMAT = "Filename must not be empty or start with a dot.";
    public static final String MESSAGE_INVALID_LONG_FILENAME_FORMAT = "Filename is too long. Keep it under 255 characters.";
